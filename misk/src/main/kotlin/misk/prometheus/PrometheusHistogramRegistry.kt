...
class PrometheusHistogramRegistry: HistogramRegistry {
        ...
        override fun newHistogram(
            ...
            var prometheusHistogramObject = PrometheusHistogram()
            prometheusHistogramObject.histogram = builder.register(collectorRegistry)
            return prometheusHistogramObject
        }
}